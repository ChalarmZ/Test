...
catchLabel.Text = "🐾 Auto Catch Divine: ปิดอยู่"
...
catchBtn.Position = UDim2.new(0, 8, 0, 460)
catchBtn.Text = "🐾  Auto Catch Divine"
catchBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
catchBtn.BackgroundColor3 = Color3.fromRGB(80, 220, 220)
